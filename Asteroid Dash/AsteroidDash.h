...
public:
    ...
    vector<vector<int> > starting_grid;
    ...
    Projectile* projectileObjectsListHead = nullptr;
    ...
    // Collision functions
    void CollisionOfObject(int collisionX, int collisionY, CelestialObject& object, Projectile* projectileObjectsListHead, Player& player);
    void CollisionOfProjectile(int collisionX, int collisionY, vector<CelestialObject>& objectsOnTheGrid, Projectile* projectile);

    // Helper functions
    void placeCelestialObject(CelestialObject& object);
    void placeProjectile(Projectile& projectile, vector<CelestialObject>& objectsOnTheGrid);
    void placePlayer();
    void cleanupCelestialObjects();
    void createRightRotationsList(CelestialObject& object);
    void createLeftRotationsList(CelestialObject& object);
    void parseAndAddCelestialObject(ifstream& file);
    vector<vector<bool>> parseMatrix(ifstream& file);
